  ...
  <section class="widget-feature overflow-hidden pd-main relative">
    ...
    <div class="tf-container w-1456 z-index3 relative">
      ...
      <div class="row">
        <div class="col-lg-12">
          <ul
            class="nav justify-content-center tab-list mb-37"
            id="myTab"
            role="tablist"
          >
          ...
          <div class="tab-content" id="myTabContent">
            ...
            >
              <div class="row">
                <div
                  class="col-md-6 col-lg-3 wow fadeInUp animated"
                  data-wow-delay="0.1s"
                >
                    ...
                    <a href="tour-single.html" class="tour-listing-image">
                      <div class="badge-top flex-two">
                        ...
                        <div class="badge-media flex-five">
                          <span class="media"
                            ><i class="icon-Group-1000002909"></i>5</span
                          >
                          <span class="media"
                            ><i class="icon-Group-1000002910"></i>2</span
                          >
                        </div>
                      </div>
                      <img src="/img/travel-list/1.jpg" alt="Image Listing" />
                    </a>
                    <div class="tour-listing-content">
                      <span class="tag-listing">Bestseller</span>
                      <span class="map"
                        ><i class="icon-Vector4"></i>United States USA</span
                      >
                      <h3 class="title-tour-list">
                        <a href="tour-single.html"
                          >Days and 6 nights From Moscow</a
                        >
                      </h3>
                      <div class="review">
                        <i class="icon-Star"></i>
                ...
                >
                  <div class="tour-listing box-sd">
                    <a href="tour-single.html" class="tour-listing-image">
                      ...
                      <img src="/img/travel-list/2.jpg" alt="Image Listing" />
                    </a>
                    <div class="tour-listing-content">
                ...
                >
                  <div class="tour-listing box-sd">
                    <a href="tour-single.html" class="tour-listing-image">
                      ...
                      <img src="/img/travel-list/3.jpg" alt="Image Listing" />
                    </a>
                    <div class="tour-listing-content">
                ...
                >
                  <div class="tour-listing box-sd">
                    <a href="tour-single.html" class="tour-listing-image">
                      ...
                      <img src="/img/travel-list/4.jpg" alt="Image Listing" />
                    </a>
                    <div class="tour-listing-content">
                      <span class="tag-listing">Bestseller</span>
                      <span class="map"
